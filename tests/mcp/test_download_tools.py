...
async def test_download_tracks_tool_registered_in_workflow(workflow_mcp):
...
async def test_download_tracks_tool_registered_in_gateway(gateway_mcp):
...
async def test_download_tracks_tool_has_correct_metadata(workflow_mcp):
    ...
    assert tool.annotations.readonly is False
