"""Shared scoring helpers — transition scoring loop.

Moved from app/mcp/tools/_scoring_helpers.py to the service layer
since this is pure business logic with no MCP framework dependencies.
"""
