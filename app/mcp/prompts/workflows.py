        ...
        return [
            Message(
                ...
                content=(
                    ...
                    "1. Use `dj_get_playlist_status` to check the current state "
                    "of the playlist and understand its audio profile "
        ...
        return [
            Message(
                ...
                content=(
                    ...
                    f"2. Use `dj_adjust_set` with set_id={set_id} and "
                    f"version_id={version_id} to suggest and apply improvements "
                    "based on the scores.\n"
