-- ============================================================================
-- DJ Techno Set Builder — Database Schema v5
...
--   • spotify_audio_features.spotify_track_id — FK на spotify_metadata
...
CREATE TABLE spotify_audio_features (
    track_id         integer    PRIMARY KEY REFERENCES tracks ON DELETE CASCADE,
    spotify_track_id text       NOT NULL REFERENCES spotify_metadata (spotify_track_id) ON DELETE CASCADE,
...
COMMENT ON COLUMN dj_beatgrid.is_canonical IS
    ...
    'но is_canonical=true должен быть ровно один (enforcement на уровне приложения).';
